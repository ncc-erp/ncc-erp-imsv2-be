...
export class AddFaceidMission1678211653433 implements MigrationInterface {
  name = 'AddFaceidMission1678211653433';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."role_permission_mission_enum" AS ENUM('cms', 'album', 'authorization', 'timesheet', 'hrm', 'hrmv2', 'face_id', 'comment', 'like', 'widget', 'setting', 'entity_type', 'upload_file', 'user')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."role_permission_mission_enum_old" AS ENUM('cms', 'album', 'authorization', 'timesheet', 'hrm', 'hrmv2', 'comment', 'like', 'widget', 'setting', 'entity_type', 'upload_file', 'user')`,
    );
    await queryRunner.query(
